...
CONTAINS
  ...
  SUBROUTINE WRITE_INFO_END
    ...
    USE MODULE_TECHCONFIG
    USE MODULE_TOOLS, ONLY    : GET_FILE_NUMBER
    USE MODULE_PHYS_VAR, ONLY : size_shock, time_shock
    ...
    WRITE(file_info,'(A15,ES18.9E3)') 'shock size (cm) ........ ', size_shock
    WRITE(file_info,'(A15,ES18.9E3)') 'shock timescale (yr) ... ', time_shock
  ...
  SUBROUTINE WRITE_OUTPUT(state)
    ...
    USE MODULE_CHEMICAL_SPECIES, ONLY : Nspec, speci, ind_H2, ind_H, ind_Hplus &
                                      , ind_Cplus, ind_C, ind_CO, ind_O, ind_OH, ind_H2O &
                                      , b_cor, e_cor, b_gra, e_gra
    USE MODULE_HEATING
    USE MODULE_MOLECULAR_COOLING
    USE MODULE_ENERGETICS
    USE MODULE_LINE_EXCIT
    USE MODULE_EVOLUTION,        ONLY : Lymana
    ...
    CHARACTER(LEN=lenfilename)   :: name_file_cooling     = 'cooling.out'
    INTEGER(KIND=LONG), SAVE     :: file_cooling
    CHARACTER(LEN=lenfilename)   :: name_file_heating     = 'heating.out'
    INTEGER(KIND=LONG), SAVE     :: file_heating
    ...
    CASE ( "first" )
       ...
       WRITE(file_phys,format_header,ADVANCE='NO')'compr_gr'
       ! Others
       ...
       ! Tests
       ! WRITE(file_phys,format_header,ADVANCE='NO')'aux1_dvn_tot'
       ! WRITE(file_phys,format_header,ADVANCE='NO')'aux1_dvn_Sn'
       ! WRITE(file_phys,format_header,ADVANCE='NO')'aux1_dvn_Vn'
       ! WRITE(file_phys,format_header,ADVANCE='NO')'aux1_dvn_Bn'
       ! WRITE(file_phys,format_header,ADVANCE='NO')'aux1_dvn_mol'
       ! WRITE(file_phys,format_header,ADVANCE='NO')'aux2_dvn_tot'
       ! WRITE(file_phys,format_header,ADVANCE='NO')'aux2_dvn_Cs'
       ! WRITE(file_phys,format_header,ADVANCE='NO')'aux2_dvn_Vn'
       WRITE(file_phys,*)
       ...
       DO i=1,Nspec
          ...
          WRITE(file_speci,format_header,ADVANCE='NO')TRIM(str)
       END DO
       WRITE(file_speci,format_header,ADVANCE='NO')'sum(i)-sum(n)'
       WRITE(file_speci,*)
       ...
       name_file_cooling = TRIM(out_dir) // TRIM(name_file_cooling)
       ...
       WRITE(file_cooling,format_header,ADVANCE='NO')'Ti'
       WRITE(file_cooling,format_header,ADVANCE='NO')'Te'
       ! Total cooling
       WRITE(file_cooling,format_header,ADVANCE='NO')'Total_cool'
       ! Total molecular cooling or analytical
       WRITE(file_cooling,format_header,ADVANCE='NO')'molec_cool'
       ! H2
       ...
       WRITE(file_cooling,format_header,ADVANCE='NO')'B_photel'

       ! fine structure
       WRITE(file_cooling,format_header,ADVANCE='NO')'Lymana'
       WRITE(file_cooling,format_header,ADVANCE='NO')'E(C+)'
       WRITE(file_cooling,format_header,ADVANCE='NO')'E(Si+)'
       WRITE(file_cooling,format_header,ADVANCE='NO')'E(H)'
       WRITE(file_cooling,format_header,ADVANCE='NO')'E(C)'
       WRITE(file_cooling,format_header,ADVANCE='NO')'E(Si)'
       ...
       !--- Neutral fluid heating terms ---
       !---          (erg/s/cm3)        ---
       !-----------------------------------
       file_heating = GET_FILE_NUMBER()
       name_file_heating = TRIM(out_dir) // TRIM(name_file_heating)
       OPEN(file_heating,file=name_file_heating,status='UNKNOWN',&
            access='SEQUENTIAL',form='FORMATTED',action='WRITE')

       WRITE(file_heating,format_header,ADVANCE='NO')'distance'
       WRITE(file_heating,format_header,ADVANCE='NO')'timeN'
       WRITE(file_heating,format_header,ADVANCE='NO')'Tn'
       WRITE(file_heating,format_header,ADVANCE='NO')'Ti'
       WRITE(file_heating,format_header,ADVANCE='NO')'Te'
       ! Total heating of the gas
       WRITE(file_heating,format_header,ADVANCE='NO')'Total_heat'
       ! Heating by chemistry
       WRITE(file_heating,format_header,ADVANCE='NO') 'heat_chemist'
       ! Heating by elastic collisions
       WRITE(file_heating,format_header,ADVANCE='NO') 'heat_diff_in'
       WRITE(file_heating,format_header,ADVANCE='NO') 'heat_diff_an'
       WRITE(file_heating,format_header,ADVANCE='NO') 'heat_diff_en'
       WRITE(file_heating,format_header,ADVANCE='NO') 'heat_diff_gn'
       ! Heating by inelastic collisions
       WRITE(file_heating,format_header,ADVANCE='NO') 'heat_inel_en'
       ! Heating by thermalization (grain & gas)
       WRITE(file_heating,format_header,ADVANCE='NO') 'heat_ther_in'
       WRITE(file_heating,format_header,ADVANCE='NO') 'heat_ther_gn'
       ! Photoelectric effect and cosmic rays
       WRITE(file_heating,format_header,ADVANCE='NO') 'heat_phot_el'
       WRITE(file_heating,format_header,ADVANCE='NO') 'heat_ioni_cr'
       WRITE(file_heating,format_header,ADVANCE='NO') 'heat_photo_chem'
       ! additional heating term
       WRITE(file_heating,format_header,ADVANCE='NO') 'heat_h2int'
       WRITE(file_heating,format_header,ADVANCE='NO') 'heat_visc'
       WRITE(file_heating,format_header,ADVANCE='NO') 'heat_compr'
       WRITE(file_heating,*)
    ...
    CASE DEFAULT
       ...
       WRITE(file_phys,format_lng,ADVANCE='NO')compr_gr
       ...
       WRITE(file_cooling,format_lng,ADVANCE='NO')Ti
       WRITE(file_cooling,format_lng,ADVANCE='NO')Te
       ! Total cooling
       WRITE(file_cooling,format_lng,ADVANCE='NO')total_n_cool
       ! Total molecular acooling or analytical cooling
       WRITE(file_cooling,format_lng,ADVANCE='NO')molec_cool
       ! H2
       ...
       ! Photo-electric effect
       WRITE(file_cooling,format_lng,ADVANCE='NO')B_photo_grain_n

       ! fine structure (ions, atoms)
       WRITE(file_cooling,format_lng,ADVANCE='NO')Lymana ! Lyman alpha dominated term (includes also e-H2 coollisions)
       WRITE(file_cooling,format_lng,ADVANCE='NO')SUM(emicpl)
       WRITE(file_cooling,format_lng,ADVANCE='NO')SUM(emisipl)
       WRITE(file_cooling,format_lng,ADVANCE='NO')SUM(emihat)
       ...
       !--------------------------
       ! heating rates (erg/s/cm3)
       !--------------------------
       WRITE(file_heating,format_lng,ADVANCE='NO')distance
       WRITE(file_heating,format_lng,ADVANCE='NO')timeN
       WRITE(file_heating,format_lng,ADVANCE='NO')Tn
       WRITE(file_heating,format_lng,ADVANCE='NO')Ti
       WRITE(file_heating,format_lng,ADVANCE='NO')Te
       ! Total heating of the gas
       WRITE(file_heating,format_lng,ADVANCE='NO')heat_n_tot
       ! Heating by chemistry
       WRITE(file_heating,format_lng,ADVANCE='NO')heat_n_chem
       ! Heating by elastic collisions
       WRITE(file_heating,format_lng,ADVANCE='NO')heat_n_diff_in
       WRITE(file_heating,format_lng,ADVANCE='NO')heat_n_diff_an
       WRITE(file_heating,format_lng,ADVANCE='NO')heat_n_diff_en
       WRITE(file_heating,format_lng,ADVANCE='NO')heat_n_diff_gn
       ! Heating by inelastic collisions
       WRITE(file_heating,format_lng,ADVANCE='NO')heat_n_inel_en
       ! Heating by thermalization (grain & gas)
       WRITE(file_heating,format_lng,ADVANCE='NO')heat_n_ther_in
       WRITE(file_heating,format_lng,ADVANCE='NO')heat_n_ther_gn
       ! Photoelectric effect and cosmic rays
       WRITE(file_heating,format_lng,ADVANCE='NO')heat_n_ph
       WRITE(file_heating,format_lng,ADVANCE='NO')heat_n_cr
       WRITE(file_heating,format_lng,ADVANCE='NO')heat_n_phchem
       ! additional terms
       WRITE(file_heating,format_lng,ADVANCE='NO')heat_n_h2int
       WRITE(file_heating,format_lng,ADVANCE='NO')heat_n_visc
       WRITE(file_heating,format_lng,ADVANCE='NO')heat_n_compr
       WRITE(file_heating,*)
