...
CONTAINS
  ...
  SUBROUTINE READ_H2_ELECTRONIC
    ...
    !    uvh2_(B & C)X%vu ..... v upper level (not used)
    !    uvh2_(B & C)X%dj ..... Delta J (J_up = J_low + Delta J) (not used)
  ...
  SUBROUTINE COMPUTE_OP_H2
    ...
    !---------------------------------------------------------------------------
    USE MODULE_PHYS_VAR, ONLY : op_H2,op_H2_in, NH2_lev, NH2_lev_var
    IMPLICIT NONE
...
!!$    endif
  ...
  SUBROUTINE EVOLUTION_H2
    ...
    !    YN_rovib_H2
    !---------------------------------------------------------------------------
    USE MODULE_PHYS_VAR, ONLY : Tn, ABS_DeltaV, NH2_lev, NH2_lev_var, distance, H_H2_flag
...
!       .OR. (H_H2_flag == "BOTH" .AND. MOD(ABS_deltaJ,2) == 0 .AND. mask_H_H2(Nup,Nlow) == .TRUE.)) THEN
  ...
  SUBROUTINE COMPUTE_H2
    ...
    USE MODULE_PHYS_VAR, ONLY : NH2_lev,NH2_lev_var,Tn,op_H2,nH,cool_KN
    USE MODULE_DEBUG_JLB
